...
%%%%%% uncomment below for first pass and comment out second pass copy
...
%% IMPORT: evaluate import command line
    try 
        ...
        error('Error importing the file: check for 1) character strings in data field 2) number headerlines (max 2) 3) variable names in the good order 4) delimiter(s) must be: ''tab , ; / :'' (no space)')
    end
