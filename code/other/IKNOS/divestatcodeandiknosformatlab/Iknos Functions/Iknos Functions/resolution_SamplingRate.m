function res=resolution_SamplingRate(a)
...
%
%  Modified 9 December 2022 (Arina Favilla): changed from min to mode when
%  calculating res
...
temp=abs(diff(a));
res=mode(   temp(  find(temp)  )  ); % find is used to avoid the zero value
